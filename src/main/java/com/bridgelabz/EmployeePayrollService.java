...
public class EmployeePayrollService {
     ...
     *
     * @param name   : taking the name of employee for matching with EmployeePayrollData list
     * @param salary : taking the salary of assigned employee for updating and passing in EmployeePayrollData list
