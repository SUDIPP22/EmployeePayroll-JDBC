...
public class EmployeePayrollDBService {
    ...
    /**
     * Purpose : To create the connection for executing query and assigned the value in a list
     *
    ...
    /**
     * Purpose : To get the details of a particular employee from the database using PreparedStatement Interface
     *
     * @throws EmployeePayrollException if the details of that particular employee is not found
     */
    private void preparedStatementForEmployeeData() throws EmployeePayrollException {
        try {
            ...
            throw new EmployeePayrollException("Please check the prepareStatementForEmployeeData() for detailed information");
        }
    }
    ...
    /**
     * Purpose : To update the salary of the employee in the database using Statement Interface
     *
     * @param name   : takes the name of the employee
     ...
     * @throws EmployeePayrollException if the assigned employee details are not found
     */
    ...
    public Map<String, Double> getTotalNumOfEmployeesByGender() throws EmployeePayrollException {
        ...
        try (Connection connection = this.getConnection()) {
            ...
            throw new EmployeePayrollException("Please check the getTotalNumOfEmployeesByGender() for detailed information");
        }
