...
public class EmployeePayrollServiceTest {
    ...
    @Test
    void givenNewSalaryForEmployee_WhenUpdated_ShouldSyncWithDB_UsingPreparedStatement() throws EmployeePayrollException {
        List<EmployeePayrollData> employeePayrollData = employeePayrollService.readEmployeePayrollData(DB_IO);
    ...
    void givenDateRange_WhenRetrieved_ShouldMatchEmployeeCount() throws EmployeePayrollException {
        ...
        List<EmployeePayrollData> employeePayrollData =
                employeePayrollService.readEmployeePayrollDataForDateRange(DB_IO, startDate, endDate);
        Assertions.assertEquals(4, employeePayrollData.size());
    }
    ...
    void givenPayrollData_WhenAverageSalaryRetrievedByGender_ShouldReturnProperValue() throws EmployeePayrollException {
        ...
        Assertions.assertTrue(averageSalaryByGender.get("M").equals(200000.00) &&
                averageSalaryByGender.get("F").equals(500000.00));
    }
    ...
    void givenPayrollData_WhenMinimumSalaryRetrievedByGender_ShouldReturnProperValue() throws EmployeePayrollException {
        ...
        Assertions.assertTrue(minimumSalaryByGender.get("M").equals(100000.00) &&
                minimumSalaryByGender.get("F").equals(500000.00));
    }
    ...
    void givenPayrollData_WhenMaximumSalaryRetrievedByGender_ShouldReturnProperValue() throws EmployeePayrollException {
        ...
        Assertions.assertTrue(maximumSalaryByGender.get("M").equals(300000.00) &&
                maximumSalaryByGender.get("F").equals(500000.00));
    }

    @Test
    void givenPayrollData_WhenAdditionOFSalaryRetrievedByGender_ShouldReturnProperValue() throws EmployeePayrollException {
        employeePayrollService.readEmployeePayrollData(DB_IO);
        Map<String, Double> totalSalaryByGender = employeePayrollService.readSumOfSalaryByGender(DB_IO);
        Assertions.assertTrue(totalSalaryByGender.get("M").equals(600000.00) &&
                totalSalaryByGender.get("F").equals(500000.00));
    }

    @Test
    void givenPayrollData_WhenCountForEmployeesRetrievedByGender_ShouldReturnProperValue() throws EmployeePayrollException {
        employeePayrollService.readEmployeePayrollData(DB_IO);
        Map<String, Double> totalNumOfEmployeesByGender = employeePayrollService.readTotalNumOfEmployeesByGender(DB_IO);
        Assertions.assertTrue(totalNumOfEmployeesByGender.get("M") == 3 &&
                totalNumOfEmployeesByGender.get("F") == 1);
    }
}
